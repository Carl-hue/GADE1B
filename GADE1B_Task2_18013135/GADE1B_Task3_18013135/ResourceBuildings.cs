...
{
    class ResourceBuildings : Buildings
    {
        ...
        public ResourceBuildings(int _xPos, int _yPos, int _HP, int _MaxHP, string _team, char _symbol) : base(_xPos, _yPos, _HP,_MaxHP, _team, _symbol)
        {
