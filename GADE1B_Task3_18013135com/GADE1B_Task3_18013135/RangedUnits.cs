...
namespace GADE1B_Task3_18013135
{
    class RangedUnits : Unit
    {
        ...
        public RangedUnits(int _xPos, int _yPos, int _HP, int _speed, int _attack, int _attackRange, string _team, char _symbol, bool _isAttacking) : base(_xPos, _yPos, _HP, _speed, _attack, _attackRange, _team, _symbol, _isAttacking)
        {
        ...
        public override bool Death() // determines whether or not the unit is dead
        {
            bool dead;
        ...
        public override string ToString() //displays the text
        {
            string output = "";
